...
export const representative_fields = {
    'label': {'key': 0, 'label': 'LABELS', 'type': 'bubble_with_subfields', 'additional_info': {
    ...
    'collection_society': {'key': 2, 'label': 'COLLECTION SOCIETIES', 'type': 'typing_bubble'},
    'distributor': {'key': 3, 'label': 'DISTRIBUTORS', 'type': 'typing_bubble'},
...
export const avs = {
  'genres': {'name':'genres', 'values': [ 
    ...
    'dance-punk', 
    'dancehall', 
    'dark ambient', 'dark electro', 'dark folk', 
    'dark wave', 
    'death metal', 
    'death-doom metal', 
    'deathcore', 
    ...
    'dungeon synth', 
    'east coast hip hop', 
    'ebm', 'edm', 'electric blues', 'electro', 
    'electro house', 
    'electro swing', 
    'electro-funk', 
    'electro-industrial', 
    ...
    'freak folk', 
    'free improvisation', 
    'free jazz', 'funk', 'funk carioca', 'funk metal', 
    'funk rock', 
    'funk soul', 
    'funky house', 
    'fusion', 
    ...
    'future jazz', 
    'futurepop', 
    'g-funk', 'gabber', 'gangsta rap', 'garage', 
    'garage house', 
    'garage punk', 
    'garage rock', 
    'glam', 
    ...
    'guaguancó', 
    'guajira', 
    'guaracha', 'happy hardcore', 'hard bop', 
    'hard house', 
    'hard rock', 
    'hard trance', 
    'hardcore hip hop', 
    ...
    'heavy psych', 
    'heavy rock', 
    'hi-nrg', 'hip hop', 'hip house', 'honky tonk', 
      'horror punk', 
      'horrorcore', 
      'house', 'idm', 'illbient', 'indie', 
      ...
      'post-rock', 
      'power electronics', 
      'power metal', 'power pop', 'powerviolence', 
      'production music', 
      'progressive', 
      'progressive folk', 
      'progressive house', 
  ...
  'music_roles': {
    'name': 'music_roles',
    'values': [ 'StudioPersonnel', 'StudioProducer', 'SurroundMixingEngineer', 
      ...
      'Grip', 'GroupMember', 
      'KeyGrip', 
      'LeadPerformer', 'LightingDirector', 
      'LightingTechnician', 
      'MasteringEngineer', 
      ...
      'PrimaryMusician', 
      'ProjectEngineer', 
      'Programmer', 'ProgrammingEngineer', 
      'ProgramProducer', 
      'RecordingEngineer', 
      ...
      'Rigger', 
      'Runner', 
      'Soloist', 'SoundDesigner', 
      'SoundMixer', 
      'SoundRecordist', 
      'SoundSupervisor', 
      'Speaker', 'StageAssistantEngineer', 
      'Stage Engineer', 'String Engineer', 'String Producer', 'Strings Director', 'Studio Conductor', 'Studio Musician',
  ]},
  'non_music_roles': {
    'name':'non_music_roles', 
    'values': [ 'Manager', 'Producer']
  },
  'instruments-played': {'name':'instruments-played', 'values': [ 'Bandoneon', 
'ChromaticButtonAccordion', 
'Concertina', 
'Cordovox', 
'Melodeon', 
'Musette', 
...
'Dzuddahord', 
'Ektara', 
'Electric6StringViolin', 
'ElectricCello', 
'ElectricHarp', 
'ElectricMandolin', 
'ElectricViola', 
'ElectricViolin', 
'ElectroAcousticHurdyGurdy', 
'Ennanga', 
'EpinetteDesVosges', 
'Erhu', 
'Esraj', 
...
'BoyVoice', 
'ChildVoice', 
'ChildrensBackgroundVocalist', 
'FemaleVoice', 
'FemaleBackgroundVocalist', 
'GirlVoice', 
'LeadVocalist', 
'MaleVoice', 
'MaleBackgroundVocalist', 
'MixedVoice', 
'MixedBackgroundVocalist', 
'NeutralVoice', 
'Alboka', 
'Alpenhorn', 
'AltoClarinet', 
