      ...
      <div className={classes.root}>
        <Paper className={classes.paper}>
          <Grid container>
            ...
            <CPButton fullWidth className={classes.submitButton} onClick={this.onSubmit}>Sign Up</CPButton>
            <div style={{color:'#b20000', textAlign:'center', margin: '1em auto 5em auto', width: '100%'}}> {this.state.error} </div>
          </Grid>
        </Paper>
      </div>
    )
